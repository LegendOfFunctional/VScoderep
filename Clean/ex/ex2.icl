...
IsEvenDecimal x y = toReal(x + y) >= toReal(toInt(x + y))
...
transform days = toString(days/365) +++ " year " +++ toString(week) +++ " week " +++ toString(week rem 7) +++ " days"
where week = (days rem 365) / 7
