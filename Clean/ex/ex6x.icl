...
// g x n = x + n
// add10 :: Int [Int] -> [Int]
// add10 list = map (gx n) list
// Start = add10 [1..8]
// 4. Triple the elements of a list.
triples :: [Int] -> [Int]
triples [] = []
triples [x:xs] = [3*x] ++ triples xs
//Start = triples [1..5] // [3,6,9,12,15]
tri :: Int -> Int
tri x = 3 * x
triples2 :: [Int] -> [Int]
triples2 list = map tri list
triple3 :: [Int] -> [Int]
triple3 list = map (\x = 3*x) list
...
ismult10 :: [Int] -> [Bool]
ismult10 list = map (\x = x rem 10 == 0) list

// ismult11 :: [Int] -> [Bool]
// ismult11 list = filter (\x = x rem 10 == 0) list
// Start = ismult10 [1..20]
...
filterOdd :: [Int] -> [Int]
// filterOdd list = filter (\x = x rem 2 == 1) list 
filterOdd list = oddNot list
// Start = filterOdd 3
